...
* [Fireworks](https://github.com/materialsproject/fireworks) - For calculation workflows, with a centralized workflow server. Features dynamic workflows, failure-detection routines, and built-in tools and execution modes for running high-throughput computations.
